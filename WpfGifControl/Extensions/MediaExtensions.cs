...
namespace WpfGifControl.Extensions;
...
public static class MediaExtensions
{
			...
			StretchDirection stretchDirection = StretchDirection.Both)
	{
		    ...
		    && (isConstrainedWidth || isConstrainedHeight))
		{
			...
			scaleX = sourceSize.Width == 0 ? 0.0 : destinationSize.Width / sourceSize.Width;
			scaleY = sourceSize.Height == 0 ? 0.0 : destinationSize.Height / sourceSize.Height;
	...
	public static Size CalculateSize(
			...
			StretchDirection stretchDirection = StretchDirection.Both)
	{
		var scaled = stretch.CalculateScaling(destinationSize, sourceSize, stretchDirection);

		return new Size(sourceSize.Width * scaled.X, sourceSize.Height * scaled.Y);
	}
}
