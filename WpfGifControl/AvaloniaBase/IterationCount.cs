...
using WpfGifControl.AvaloniaBase.Converters;
...
public readonly struct IterationCount : IEquatable<IterationCount>
{
	...
	public IterationCount(ulong value, IterationType type = IterationType.Many)
	{
