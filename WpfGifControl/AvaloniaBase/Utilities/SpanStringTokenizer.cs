...
internal ref struct SpanStringTokenizer
{
	...
	public SpanStringTokenizer(ReadOnlySpan<char> s, char separator = DefaultSeparatorChar,
	...
	public bool TryReadInt32(out Int32 result, char? separator = null)
	{
		if (TryReadSpan(out var stringResult, separator) &&
		    stringResult.TryParseInt(NumberStyles.Integer, _formatProvider, out result))
		{
			return true;
		}
		else
