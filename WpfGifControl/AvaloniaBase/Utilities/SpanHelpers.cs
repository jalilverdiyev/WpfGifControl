...
namespace WpfGifControl.AvaloniaBase.Utilities;

internal static class SpanHelpers
{
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool TryParseUInt(this ReadOnlySpan<char> span, NumberStyles style, IFormatProvider provider,
			out uint value)
	{
#if NETSTANDARD2_0
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool TryParseInt(this ReadOnlySpan<char> span, NumberStyles style, IFormatProvider provider,
			out int value)
	{
#if NETSTANDARD2_0
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool TryParseDouble(this ReadOnlySpan<char> span, NumberStyles style, IFormatProvider provider,
			out double value)
	{
#if NETSTANDARD2_0
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool TryParseByte(this ReadOnlySpan<char> span, NumberStyles style, IFormatProvider provider,
			out byte value)
	{
#if NETSTANDARD2_0
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool TryParseEnum<TEnum>(this ReadOnlySpan<char> span, bool ignoreCase, out TEnum value)
			where TEnum : struct
	{
#if NETSTANDARD2_0
